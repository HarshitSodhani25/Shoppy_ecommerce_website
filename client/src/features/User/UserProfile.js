...
export default function Login() {
    ...
    const handleAdd = (address) => {
        const updateUser = { ...user, addresses: [...user.addresses, address] };
    ...
    const handleEditForm = (index) => { setSelectedEditIndex(index); const address = user.addresses[index]; setValue('name', address.name); setValue('email', address.email); setValue('city', address.city); setValue('state', address.state); setValue('postalCode', address.postalCode); setValue('phoneNumber', address.phoneNumber); setValue('streetAddress', address.streetAddress);
      };
